...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1473837807, '1', './data/template/1_1_common_header_forum_forumdisplay.tpl.php', './template/default', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1473837807, '1', './data/template/1_1_common_header_forum_forumdisplay.tpl.php', './template/default', 'common/header_forum_forumdisplay')
;?>
...
<div class="top">
<div class="w1170">
        <div class="logo fl"><img height="70" src="/static/image/images/logo.png"></div>
        <div class="nav fl">
        	<ul class="nav_list">
            	<li><a href="#">首页</a></li>
                <li><a href="#">广场</a></li>
...
</div>--><?php include template('common/header_userstatus'); ?><div class="clear"></div>
    </div>
</div>

<div id="append_parent"></div><div id="ajaxwaitid"></div><?php include template('common/header_diy'); if(check_diy_perm($topic)) { include template('common/header_diynav'); } if(CURMODULE == 'topic' && $topic && empty($topic['useheader']) && check_diy_perm($topic)) { ?>
<?php echo $diynav;?>
