...
use common\components\ossphpsdk\OssUploadFile;
/**
...
//         }
        ...
        $oss = new OssUploadFile();
        if(!$oss->fileUploadToOss($file["tmp_name"], $this->filePath)){
...
//         }
        ...
        $oss = new OssUploadFile();
        if(!$oss->dataUploadToOss($img, $this->filePath)){
        	$this->stateInfo = $this->getStateInfo("ERROR_FILE_MOVE");
        } else { //移动成功
        	$this->stateInfo = $this->stateMap[0];
        }
