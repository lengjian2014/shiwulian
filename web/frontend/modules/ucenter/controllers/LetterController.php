...
class LetterController extends FrontController
{
    ...
    {
    	//收件箱
    	list($inbox, $pages) = StationLetter::getAllByCondition(['to_uid' => \Yii::$app->user->id, 'pid' => 0], "id desc");
    ...
    {
    	//发件箱
    	list($outbox, $pages) = StationLetter::getAllByCondition(['from_uid' => \Yii::$app->user->id, 'pid' => 0], "id desc");
