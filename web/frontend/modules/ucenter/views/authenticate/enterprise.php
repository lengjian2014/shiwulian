		...
		<div class="col-xs-12 col-sm-9">
				...
				<div class="ucenter-content panel-content" style="padding:0px 20px 60px 20px;min-height:550px;">
					...
					<div id="myTabContent" class="tab-content">
							<div id="home" class="tab-pane fade <?=$model->type == 0 ? 'active in' : ''?>" aria-labelledby="home-tab" role="tabpanel" style="margin-top:30px;padding-left:20px;">
							...
							<div id="profile" class="tab-pane fade <?=$model->type == 1 ? 'active in' : ''?>" aria-labelledby="profile-tab" role="tabpanel" style="margin-top:30px;padding-left:20px;">
								<?php $form = ActiveForm::begin([
													      	'id' => 'enterprise-form',
					    									'options' => ['class' => 'form-horizontal','enctype' => 'multipart/form-data'],
													        'fieldConfig' => [  
							    ...
							    <?= $form->field($model, 'name')->textInput()->label("证件名称") ?>
