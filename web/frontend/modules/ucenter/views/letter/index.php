		...
		<div class="col-xs-12 col-sm-9">
				...
				<div class="ucenter-content panel-content" style="min-height:550px;padding-top:10px;">
					<ul class="nav nav-tabs" style="margin-bottom:20px;">
					  <li role="presentation" class="<?=$this->context->action->id=='inbox'?'active':''?>"><a href="<?=Yii::$app->urlManager->createUrl(['/ucenter/letter/inbox'])?>">收件箱</a></li>
					  <li role="presentation" class="<?=$this->context->action->id=='outbox'?'active':''?>"><a href="<?=Yii::$app->urlManager->createUrl(['/ucenter/letter/outbox'])?>">发件箱</a></li>
					</ul>
						...
						<div style="background-color: #fff;padding:15px 15px;">
							...
							<div style="padding-left:80px;">
								...
								<p  style="padding:10px 0px 5px 0px;">
									...
									<span style="font-size:12px;float: right;padding-left:5px;"><a>已经回复，共2条对话</a></span>
								</p>
							</div>
					 </div>
				</div>
